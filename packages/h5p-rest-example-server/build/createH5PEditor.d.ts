 ...
 */
export default function createH5PEditor(config: H5P.IH5PConfig, urlGenerator: H5P.IUrlGenerator, permissionSystem: H5P.IPermissionSystem, localLibraryPath: string, localContentPath?: string, localTemporaryPath?: string, localContentUserDataPath?: string, translationCallback?: H5P.ITranslationFunction, hooks?: {
