...
define(["require", "exports", "react"], function (require, exports, react_1) {
    ...
    const yesNo = (value) => value ? (react_1.default.createElement("span", { className: "fa fa-check text-success" })) : (react_1.default.createElement("span", { className: "fa fa-times text-danger" }));
    const LibraryDetailsComponent = (props) => (react_1.default.createElement("div", null, props.details === undefined ? (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("button", { className: "btn btn-secondary float-right", onClick: () => props.onClose() }, "Close"),
            ...
            react_1.default.createElement("table", { className: "table-sm table-borderless" },
                ...
                react_1.default.createElement("tbody", null,
                    ...
                    react_1.default.createElement("tr", null,
                        ...
                        react_1.default.createElement("td", null, props.details.embedTypes?.join(' ') || '-')),
                    react_1.default.createElement("tr", null,
    ...
    exports.default = LibraryDetailsComponent;
});
